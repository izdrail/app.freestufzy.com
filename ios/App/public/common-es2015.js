...
let WordpressService = class WordpressService {
    ...
    getPost(postId) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.api_url
            + 'posts/' + postId);
    }
    getRecentPosts(categoryId, page = 1) {
        ...
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.api_url
            ...
            + category_url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((posts) => {
            posts.forEach((post) => {
    ...
    createComment(postId, user, comment) {
        let header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Authorization', 'Bearer ' + user.token);
