(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~login-login-module~post-post-module~posts-posts-module~register-register-module"],{
...
let AuthenticationService = class AuthenticationService {
    constructor(http) {
        this.http = http;
        this.loggedUser = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
    }
    getUser() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const { value } = yield Storage.get({ key: 'user' });
            return value;
        });
    }
    setUser(user) {
    ...
    isLoggedIn() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.getUser())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["concatMap"])(user => {
            if (user) { // user is the value returned from the local storage
                return this.validateAuthToken(JSON.parse(user).token)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(error)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(result => {
                    if (result.error) {
                        // token is expired
                        return false;
                    }
    ...
    doLogin(username, password) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.auth_url, {
            username: username,
            password: password
        });
    }
    doRegister(userData, token) {
        let header;
        // tslint:disable-next-line:indent
        header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: 'Bearer ' + token });
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.api_url + 'users', userData, { headers: header });
    }
    validateAuthToken(token) {
        let header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: 'Bearer ' + token });
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.auth_url + '/validate?token=' + token, {}, { headers: header });
    }
};
...
//# sourceMappingURL=default~login-login-module~post-post-module~posts-posts-module~register-register-module-es2015.js.map