      ...
      var AuthenticationService = /*#__PURE__*/function () {
        ...
        _createClass(AuthenticationService, [{
          ...
          value: function isLoggedIn() {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.getUser()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["concatMap"])(function (user) {
              if (user) {
                // user is the value returned from the local storage
                return _this2.validateAuthToken(JSON.parse(user).token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
          ...
          key: "loggedUserObservable",
          value: function loggedUserObservable() {
          ...
          key: "doRegister",
          value: function doRegister(userData, token) {
            var header; // tslint:disable-next-line:indent

            header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              Authorization: 'Bearer ' + token
            });
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.api_url + 'users', userData, {
              headers: header
            });
          }
        }, {
          key: "validateAuthToken",
          value: function validateAuthToken(token) {
            var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              Authorization: 'Bearer ' + token
            });
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].wordpress.auth_url + '/validate?token=' + token, {}, {
              headers: header
            });
          }
        }]);
...
//# sourceMappingURL=default~login-login-module~post-post-module~posts-posts-module~register-register-module-es5.js.map