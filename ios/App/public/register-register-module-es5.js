(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function b0Bx(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_wordpress_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(router, formBuilder, wordpressService, authenticationService, toastController) {
        ...
        _createClass(RegisterPage, [{
          ...
          value: function onSubmit() {
            ...
            var password = 'garcea'; // this should be an administrator Password
            // only authenticated administrators can create users

            this.authenticationService.doLogin(username, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (error) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["of"])(error);
            })).subscribe(function (res) {
              if (res.error) {
                _this.errorMessage = 'Only authenticated administrators can create users';
              } else {
                var userData = {
                  username: _this.registerForm.value.username,
                  name: _this.registerForm.value.displayName,
                  email: _this.registerForm.value.email,
                  password: _this.registerForm.value.password
                };

                _this.authenticationService.doRegister(userData, res.token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (error) {
                  return Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["of"])(error);
                })).subscribe(function (result) {
                  if (res.error) {
                    _this.errorMessage = 'Only authenticated administrators can create users';
                  } else {
                    _this.successMessage = 'Account created successfully. Please log in.';
                  }
                });
              }
            }, function (err) {
