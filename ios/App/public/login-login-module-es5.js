  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(router, loadingController, formBuilder, authenticationService) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      this.authenticationService.doLogin(this.loginForm.value.username, this.loginForm.value.password).subscribe(function (res) {
    ...
    function i7c(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginGuard = /*#__PURE__*/function () {
        function LoginGuard(authenticationService, router) {
        ...
        _createClass(LoginGuard, [{
          ...
          value: function canActivate() {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.authenticationService.getUser()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function (user) {
              if (user) {
                // user is the value returned from the local storage
                return _this2.authenticationService.validateAuthToken(JSON.parse(user).token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                  ...
                  if (result.error) {
                    ...
                    return _this2.router.parseUrl('/posts');
                  }
                }));
              } else {
      ...
      LoginGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], LoginGuard);
      /***/
    },
    ...
    function X3zk(module, __webpack_exports__, __webpack_require__) {
      ...
      var _login_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./login.guard */
      "4i7c");
